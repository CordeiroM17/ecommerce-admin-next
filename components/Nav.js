...
export default function Nav({show}) {
    ...
    const activeLink = inactiveLink+ ' text-primaryText-100';
    const inactiveIcon = 'w-8 h-8 p-1 bg-primaryBg-200 rounded-md';
    const activeIcon = inactiveIcon+ ' bg-primaryColor-100 text-primaryColor-300'
    ...
    return (
        <aside className={(show ? 'left-0' : '-left-full') + " top-0 text-primaryText-200 p-4 fixed w-full bg-primaryBg-300 h-full md:static md:w-auto transition-all"}>
            ...
            <nav className="flex flex-col gap-2 text-primaryText-200">
